    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(default='static/app/profile_pictures/default.png', upload_to='static/app/profile_pictures/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('S', 'Sent'), ('B', 'Blocked'), ('A', 'Accepted'), ('D', 'Declined')], default='S', max_length=1)),
